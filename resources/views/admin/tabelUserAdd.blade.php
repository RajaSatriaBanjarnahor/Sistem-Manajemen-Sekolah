                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group local-forms">
                                ...
                                <input class="form-control" type="text" name="name" value="{{ old('name') }}" required autocomplete="name" placeholder="Enter Full Name">
                                @error('name')
                        ...
                        <div class="col-12 col-sm-6">   
                            <div class="form-group local-forms">
                                ...
                                <input class="form-control" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Enter Email">
                                @error('email')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group local-forms">
                                ...
                                <input class="form-control" id="SiswaID" name="SiswaID" type="text">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group local-forms">
                                <label>Guru ID </label>
                                <input class="form-control" id="GuruID" name="GuruID" type="text">
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group local-forms">
